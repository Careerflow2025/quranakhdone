-- Complete Supabase Schema for Quranakh (FIXED VERSION)
...
-- User Profiles table to store role and school information
-- This replaces trying to modify auth.users directly
