...
CREATE TABLE IF NOT EXISTS public.notifications (
  ...
  section text NOT NULL, -- 'assignments', 'highlights', 'gradebook', 'mastery', 'attendance', 'targets', 'classes', 'messages', 'credentials', 'analytics'
  type text NOT NULL, -- notification type (e.g., 'assignment_created', 'highlight_added', 'grade_posted', etc.)
  title text NOT NULL,
  message text NOT NULL,

  -- Optional metadata for navigation
  metadata jsonb DEFAULT '{}'::jsonb, -- Can store { assignment_id, highlight_id, student_id, etc. }
