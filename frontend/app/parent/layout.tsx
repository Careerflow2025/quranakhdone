...
import { BookOpen, Users, Settings, LogOut, Home, Calendar, MessageCircle, TrendingUp } from 'lucide-react';
...
const navigationItems = [
  ...
  { name: 'Progress Reports', href: '/parent/reports', icon: TrendingUp },
  { name: 'Communication', href: '/parent/messages', icon: MessageCircle },
