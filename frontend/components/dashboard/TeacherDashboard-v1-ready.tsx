              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-6 space-y-3">
                    {todaySchedule.map((item: any, index: any) => (
              ...
              <div className="bg-white rounded-lg border overflow-hidden">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y">
                    {classDetails[selectedAttendanceClass]?.studentList?.map((student: any) => {
          ...
          <div className="space-y-6">
                        ...
                        return (
                          ...
                          {isValidDay && (
                            <>
                              ...
                              <div className="space-y-1">
                                {events.slice(0, 2).map((event: any, idx: any) => (
                                  <div 
                                    key={idx}
                                    onClick={() => {
              ...
              {calendarView === 'week' && (
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-8 gap-2">
                    ...
                    {/* Days Columns */}
                    {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day: any, dayIndex: any) => {
                        ...
                        <div key={day} className="border-l">
                          ...
                          <div className="relative h-[800px]">
                            {calendarType === 'personal' && dayIndex >= 1 && dayIndex <= 5 ? (
                              ...
                              <>
                                {/* School Events */}
                                {dayEvents.map((event: any, idx: any) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                <div className="space-y-2">
                  {todaySchedule.slice(0, 3).map((item: any, idx: any) => (
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {teacherInfo.subjects.map((subject: any, index: any) => (
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="bg-white rounded-lg border overflow-hidden">
                <table className="w-full">
                  ...
                  <tbody className="divide-y">
                    {selectedClassDetails.studentList?.map((student: any) => (
                      <tr key={student.id} className="hover:bg-gray-50">
                        <td className="py-3 px-4">
                          <div className="flex items-center">
                  ...
                  <div className="bg-white rounded-xl border p-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(selectedStudent.strengths || ['Tajweed', 'Memorization']).map((strength: any, index: any) => (
                            <span key={index} className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">
                              {strength}
                            </span>
                          ))}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(selectedStudent.needsImprovement || ['Makharij']).map((area: any, index: any) => (
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50">
              {assignmentConversations[selectedAssignment.id] ? (
                assignmentConversations[selectedAssignment.id].map((message: any) => (
                  <div
                    key={message.id}
